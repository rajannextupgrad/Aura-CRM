      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-lg leading-relaxed">
            Stop managing data. Start managing relationships. Nexus uses
            predictive AI to automate outreach, score leads, and close deals
            while you sleep.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              size="lg"
              className="h-12 px-8 rounded-full bg-primary text-white hover:bg-primary/90 text-base font-semibold shadow-[0_0_20px_hsl(var(--primary)/0.3)]"
            >
              Start Free Trial
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-12 px-8 rounded-full border-white/10 hover:bg-white/5 text-base"
            >
              Watch Demo
            </Button>
          </div>
          ...
          <div className="mt-12 flex items-center gap-4 text-sm text-muted-foreground">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="h-8 w-8 rounded-full border border-background bg-secondary flex items-center justify-center text-[10px] overflow-hidden"
                >
                  <img
              ...
              >
                ...
                <div className="bg-white/5 border border-white/5 rounded-2xl rounded-tl-none p-4 text-sm max-w-[80%]">
                  <p className="text-gray-300">
                    I've analyzed your pipeline. Deal velocity is up 12% this
                    week. Would you like me to draft follow-ups for the top 5
                    stalling opportunities?
                  </p>
                </div>
              </motion.div>
